package com.app.healthcare.integrationtest;
...
import com.app.healthcare.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("healthcare", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/healthcare/Appointments?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/healthcare/Appointments/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM healthcare.Appointment");
    jdbcTemplate.execute("DELETE FROM healthcare.Patient");
    jdbcTemplate.execute("DELETE FROM healthcare.Doctor");
     jdbcTemplate.execute("DELETE FROM healthcare.PatientAppointment");
